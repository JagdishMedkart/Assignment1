...
"[project]/src/app/api/products/[wsCode]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const deleteDirectoryRecursive = (dirPath)=>{
    if (__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(dirPath)) {
        ...
        files.forEach((file)=>{
            const currentPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dirPath, file);
            if (__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].lstatSync(currentPath).isDirectory()) {
                deleteDirectoryRecursive(currentPath); // Recurse into subdirectories
            } else {
                __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].unlinkSync(currentPath); // Delete file
            }
        });
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].rmdirSync(dirPath); // Delete the directory itself
    }
};
    ...
    try {
        ...
        if (!wsCodeNumber) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "wsCode is required to delete the product",
                success: false
            }, {
                status: 400
            });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1a0efd._.js.map