...
async function POST(req) {
    try {
        ...
        const wsCode = parseInt(formData.get("wsCode"));
        const salesPrice = parseFloat(formData.get("salesPrice"));
        const mrp = parseFloat(formData.get("mrp"));
        const packageSize = parseFloat(formData.get("packageSize"));
        ...
        for (const image of images){
            ...
            const imageName = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2d$node$2f$v4$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])()}-${image.name}`;
            const imagePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "public/uploads", imageName);
            await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].writeFile(imagePath, Buffer.from(buffer));
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__49f475._.js.map