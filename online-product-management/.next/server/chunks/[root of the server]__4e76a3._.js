...
async function POST(req) {
    try {
        ...
        const category = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].category.create({
            data: {
                name
            }
        });
...
async function GET() {
    try {
        const categories = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].category.findMany({
            orderBy: {
                name: "asc"
            }
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4e76a3._.js.map