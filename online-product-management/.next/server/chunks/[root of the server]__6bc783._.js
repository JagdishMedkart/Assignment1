...
async function POST(req) {
    try {
        const { name, mrp, packageSize, categoryId, tags, images } = await req.json();
        // Validate required fields
        if (!name || !mrp || !packageSize || !categoryId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "All fields except images and tags are required!",
                success: false
            }, {
                status: 400
            });
        ...
        if (images) {
            for (const [index, base64Image] of images.entries()){
                ...
                const imagePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(uploadDir, `${index + 1}.jpg`); // Save images as 1.jpg, 2.jpg, etc.
...
function getRandomWsCodes(wsCodes, limit) {
    const randomWsCodes = [];
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6bc783._.js.map