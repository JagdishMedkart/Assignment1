...
"[project]/src/middleware/authMiddleware.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function withAuth(req, res) {
    ...
    try {
        const userSession = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].session.findUnique({
            where: {
                sessionToken: token
            },
            include: {
        ...
        req.user = userSession.user; // Attach user to request object
        return res;
    } catch (error) {
...
"[project]/src/app/api/cart/update/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/server.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/prisma/client.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$authMiddleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/middleware/authMiddleware.ts [app-route] (ecmascript)"); // Import the authentication middleware
;
;
;
async function POST(req) {
    try {
        ...
        const newItem = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].cartItem.create({
            data: {
                userId: user.userId,
                productId,
                quantity
...
const config = {
    handler: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$middleware$2f$authMiddleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"]
};
}}),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7be226._.js.map