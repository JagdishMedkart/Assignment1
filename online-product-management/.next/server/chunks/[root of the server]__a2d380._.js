...
const handler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
    ...
    callbacks: {
        async signIn ({ user }) {
            try {
                const dbUser = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUnique({
                    where: {
                        email: user.email
                    }
                });
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])()).set("session-us", sessionToken, {
                    expires
                });
                return true;
            } catch (error) {
        ...
        async session ({ session }) {
            try {
                ...
                const activeSession = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].session.findFirst({
                    where: {
                        userId: dbUser.userId,
                        expires: {
                            gt: new Date()
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])()).set("session-us", activeSession.sessionToken, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a2d380._.js.map