...
"[project]/src/app/api/admin/orders/[orderId]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    try {
        ...
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.findUnique({
            where: {
                orderId
            },
            include: {
        ...
        const totalAmount = order.orderItems.reduce((acc, item)=>acc + item.totalPrice * 0.9, 0);
...
async function PATCH(req, { params }) {
    try {
        ...
        const updatedOrder = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.update({
            where: {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a44423._.js.map