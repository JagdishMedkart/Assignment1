...
const EmailTransport = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$nodemailer$2f$lib$2f$nodemailer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].createTransport({
    service: "gmail",
    auth: {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/prisma/client.ts [app-route] (ecmascript)"); // Corrected path
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$util$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/lib/util.ts [app-route] (ecmascript)");
...
const handler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
    ...
    callbacks: {
        async signIn ({ user, account, profile, email, credentials }) {
            console.log(user);
            const dbuser = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findFirst({
                where: {
                    email: user.email
                }
            });
            ...
            (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])()).set("session-us", sessionToken, {
                expires: futureDate
            });
            return true;
        },
        ...
        async session ({ session, token, user }) {
            ...
            const now = new Date();
            const ourSess = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].session.findFirst({
                where: {
                    userId: dbuser.userId,
                    expires: {
                        gt: now
            ...
            (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])()).set("session-us", ourSess.sessionToken, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d0e9e0._.js.map