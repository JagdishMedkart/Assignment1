...
"[project]/src/components/Auth/CheckLoginStatus.tsx [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function checkLoginStatus() {
    const sessionToken = (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cookies"])()).get("session-us")?.value; // Adjust cookie key as needed
    if (!sessionToken) {
...
"[project]/src/app/api/auth/check/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Auth$2f$CheckLoginStatus$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/components/Auth/CheckLoginStatus.tsx [app-route] (ecmascript)");
;
async function handler(req, res) {
    try {
        const isLoggedIn = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Auth$2f$CheckLoginStatus$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkLoginStatus"])();
        res.status(200).json({
            isLoggedIn
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d4a6c1._.js.map