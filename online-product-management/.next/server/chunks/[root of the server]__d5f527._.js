...
"[project]/src/app/api/auth/authSchema.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const authSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].object({
    Username: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().min(1, 'Username is required.').max(255),
    ...
    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["z"].string().min(1, 'Password hash is required.')
});
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$auth$2f$authSchema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/api/auth/authSchema.ts [app-route] (ecmascript)");
...
async function POST(req) {
    try {
        if (req.method === 'POST') {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json('Method not allowed', {
                status: 405
            });
        }
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d5f527._.js.map