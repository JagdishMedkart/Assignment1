...
"[project]/src/app/api/order/place/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!userId || !orderItems || orderItems.length === 0 || !totalAmount || !address) {
        ...
        // Create order
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.create({
            data: {
                userId,
                totalAmount,
                address: address,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d7383b._.js.map