...
async function GET(req) {
    try {
        ...
        const mostBoughtProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].orderItem.groupBy({
            by: [
                "productWsCode"
            ],
            where: {
        ...
        const mostBoughtProductDetails = mostBoughtProduct.length ? await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].product.findUnique({
            where: {
                wsCode: mostBoughtProduct[0].productWsCode
            }
        }) : null;
        // Prepare stats
        const stats = {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e0ee22._.js.map