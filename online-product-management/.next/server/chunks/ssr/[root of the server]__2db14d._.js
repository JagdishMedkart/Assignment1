...
const ProductDetail = ()=>{
    ...
    const { cart, removeFromCart, clearCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$CartContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCart"])();
        ...
        if (wsCode) {
            ...
            const fetchProduct = async ()=>{
                try {
                    ...
                    console.log(data);
                    setProduct(data.product); // Assume the API returns the product object
                } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__2db14d._.js.map