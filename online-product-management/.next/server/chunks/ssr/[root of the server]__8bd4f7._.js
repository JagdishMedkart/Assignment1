...
;
const CartPage = ()=>{
    const { cart, removeFromCart, addToCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$CartContext$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["useCart"])();
    ...
    const handleDecreaseQuantity = (productId)=>{
        ...
        if (item) {
            if (item.quantity > 1) {
                ...
                removeFromCart(productId); // Remove item if quantity reaches 1
            }
        }
    };
    ...
    const handlePlaceOrder = ()=>{
        ...
        if (!userLoggedIn) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].error("Please log in first!");
            return;
        }
    // Show modal to confirm order
    // Call the placeOrder function once confirmed (we'll implement modal next)
    };
...
"[project]/.next-internal/server/app/cart/page/actions.js [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8bd4f7._.js.map