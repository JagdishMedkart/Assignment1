(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__32a4ad._.js", {
...
"[project]/prisma/client.ts [middleware] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/prisma/client.ts [middleware] (ecmascript)");
...
async function middleware(req) {
    ...
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$client$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["default"].user.findFirst({
        where: {
            sessions: {
                some: {
                    sessionToken
    ...
    if (!user || !user.isSuperAdmin) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(accessDeniedUrl);
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].next(); // Allow access
}
const config = {
    matcher: [
        "/dashboard/:path*",
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__32a4ad._.js.map