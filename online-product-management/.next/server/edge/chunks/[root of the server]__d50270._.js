...
{
// In /middleware.ts (or /middleware.js)
__turbopack_esm__({
...
async function middleware(req) {
    ...
    if (!sessionToken) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/', req.url)); // Redirect to homepage if not logged in
    }
    // Check if user is a super admin
    const user = await fetchUser(sessionToken); // You need to implement fetchUser to get the user based on session
    if (!user?.isSuperAdmin) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/profile', req.url)); // Redirect to profile page if not a super admin
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$spec$2d$extension$2f$response$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].next(); // Proceed to dashboard if user is a super admin
}
