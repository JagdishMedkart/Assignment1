(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_f48819._.js", {
...
const ProductDashboard = ({ products })=>{
    _s();
    const [productState, setProductState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(products);
    ...
    const [deleteProductWsCode, setDeleteProductWsCode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const handleDelete = async (wsCode)=>{
        ...
        try {
            ...
            if (response.ok) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(data.message || "Failed to delete product.");
            }
        } catch (error) {
    ...
    const handleToggleStatus = async (wsCode, newStatus)=>{
        try {
            ...
            if (response.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`Product ${newStatus ? "Disabled" : "Enabled"} Successfully`);
                setProductState((prev)=>prev.map((product)=>product.wsCode === wsCode ? {
                            ...product,
                            enabled: !product.enabled
                        } : product));
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Failed to toggle product status.");
            }
        } catch (error) {
            console.error("Error toggling product status:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("An error occurred while toggling product status.");
        }
    };
...
_s(ProductDashboard, "YaQlbUTkb9VCj9lEeCcHs2VifU0=", false, function() {
    return [
...
var _c;
__turbopack_refresh__.register(_c, "ProductDashboard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_f48819._.js.map