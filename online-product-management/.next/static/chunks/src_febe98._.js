(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_febe98._.js", {
...
const ProductDetail = ()=>{
    ...
    const wsCode = params.wsCode;
    const { addToCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$CartContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCart"])(); // Update to use CartContext that works with DB now
    ...
    const handleAddToCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProductDetail.useCallback[handleAddToCart]": async ()=>{
            ...
            if (quantity <= 0) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("You must need atleast 1 in quantity!");
            }
            setIsAdding(true); // Disable button while adding
            try {
...
_s(ProductDetail, "hUbNxHq0/8hzGe5LeO+jK+dsYO8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=src_febe98._.js.map