...
-- AddForeignKey
ALTER TABLE "OrderItem" ADD CONSTRAINT "fk_orderItem_product" FOREIGN KEY ("productWsCode") REFERENCES "Product"("wsCode") ON DELETE SET NULL ON UPDATE CASCADE;
