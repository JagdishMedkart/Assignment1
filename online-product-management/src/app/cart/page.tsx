  ...
  const fetchCart = async () => {
    try {
      ...
      if (response.ok) {
        ...
        toast.error("Please, Login to see your cart items!");
      }
    } catch (error) {
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-gray-500">${0.9 * item.product.mrp}</p>
                  </div>
                </div>
                <div className="flex items-center space-x-2">
                  <button
                ...
                <tbody>
                  {orderDetails.map((order) => (
                    <tr key={order.productId}>
                      ...
                      <td className="px-4 py-2">{order.quantity}</td>
                      <td className="px-4 py-2">${order.product.mrp * 0.9}</td>
                      <td className="px-4 py-2">${order.product.mrp * order.quantity * 0.9}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
              {/* Grand total section */}
              <div className="flex justify-center font-semibold ml-4 mr-4">
                <span>{"Total:" + "   "}</span>
                <span>
